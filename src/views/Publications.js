...
const s = () => {
  const s = [
    {
      heading: ' 1',
      authors: ['Zachary N Blalock, Gwyneth W Y Wu, Daniel Lindqvist, Caroline Trumpff, Janine D Flory, Jue Lin, Victor I Reus, Ryan Rampersaud, Rasha Hammamieh, Aarti Gautam, SBPBC, Ressler Kerry J., Yang Ruoting, Muhie Seid, Daigle Bernie J. Jr, Bierer Linda M., Hood Leroy, Wang Kai, Lee Inyoul, Dean Kelsey, Somvanshi Pramod R., Francis J Doyle III, Charles R Marmar, Marti Jett, Rachel Yehuda, Owen M Wolkowitz, Synthia H Mellon'],
      year: 2024,
  ...
  return (
    <div>
      <h1 style={{ color: '#990000', display: 'flex', justifyContent: 'center' }}>s</h1>
      <div
