          ...
          <Grid item xs={12} sm={12} md={10}>
            <div className="content-container">
              ...
              <Typography variant="p" style={{ fontSize: '17px' }}>
                Our laboratory is dedicated to translational research in Systems Medicine and Therapeutic Engineering. Our research interests are in 
                applying systems engineering principles to biomedical systems for better healthcare. Understanding the design principles of biological 
                systems can help in developing strategies to modify and reconstruct biological processess with desired properties. Therefore, for the
                physiological systems, we treat a disease diagnosis problem analogous to a fault diagnosis problem in engineering systems and develop 
                tools to better inform treatment decisions and therapeutic strategies. 
                <br />
                <br />
